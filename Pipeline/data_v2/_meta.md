...
- **profile_overview.md** — Overview, contact info, career focus, and synthesized professional strengths across all roles. (tags: career_transition, solutions_engineering, cross_functional)
- **technical_skills.md** — Full inventory of languages, frameworks, infrastructure, data/messaging, frontend, and tooling skills. (tags: tech_stack)
...
- **ai_chatbot_project.md** — AI chatbot deployed on personal website as an interactive resume. (tags: ai_ml, chatbot, personal_website) [stub — see chatbot_* files for full detail]
...
- **chatbot_rag_pipeline.md** — Knowledge base structure (29 markdown files + YAML metadata), chunking evolution (500→1800 chars), RRF hybrid retrieval, query expansion, company filtering. (tags: rag, retrieval, hybrid_search, chunking)
...
- **src_se_narratives_and_stories.md** — Five SE-positioning narratives plus four interview-ready STAR stories (COP is King, stateless round-trip, SME collaboration, onboarding). (tags: solutions_engineering, star_stories, interview_prep)
...
- **smartlock_hardware.md** — ESP32, capacitive peephole sensor, DS-S012 servo, 9V battery, BLE beacon, 3D-printed housing, deep-sleep power architecture, servo mechanical linkage, command-strip installation. (tags: hardware_design, deep_sleep, servo, mechanical_linkage)
...
**Total:** 29 files (7 profile + 7 DraftKings + 8 SRC + 7 VaughnKey) + this index.
